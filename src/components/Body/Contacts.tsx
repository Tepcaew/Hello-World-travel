        ...
        <YMaps className={styles.map}>
          ...
          />
           ...
           <div className={styles.titleTwo}>
            ...
            <p>+7 928 593 81 81</p>
            <p>ethnotravel@marwa.ru</p>
            <p>Офис работает с 10:00 до 17:00, Обед 12:00 - 13:00. Выходной - Воскресенье</p>
        ...
        <YMaps className={styles.map}>
          ...
          />
           ...
           <input type="text" />
            ...
            <p className={styles.pt}>Нажимая на кнопку "Отправить", Вы соглашаетесь с условиями и пользовательским соглашением.</p>
           </div>
        </div>
    );
};
